...
namespace API.Database.Migrations
{
    ...
    [Migration("20260513215000_SecurityEventAudit")]
    partial class SecurityEventAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Database.DuckSoup.SecurityEvent", b =>
                {
                    b.Property<int>("SecurityEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SecurityEventId"));
                    ...
                    b.HasKey("SecurityEventId")
                        .HasName("PK_dbo.SecurityEvent");

                    b.HasIndex("EventType", "IX_SecurityEvent_EventType");

                    b.HasIndex("TimestampUtc", "IX_SecurityEvent_TimestampUtc");

                    b.ToTable("SecurityEvent", (string)null);
                });
